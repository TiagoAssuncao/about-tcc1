...
A Rede Social About (RSA) tem o propósito de dar transparência as personalidades de seus usuários, que aceitaram os
termos de consentimento. Estes podem criar abouts para seus amigos, onde, estes serão todos anônimos. A fim de julgar
sobre a veracidade deste about, os demais amigos do usuário poderão votar, também anonimamente, sobre a veracidade
julgando se é uma verdade ou uma mentira.

A proposta deste trabalho é desenvolver e aplicar uma instância do framework octalysis de gamificação na RSA. Os seguintes
...
Será elaborado um piloto, tal qual será um site desenvolvido com as funcionalidades básicas da RSA, sem levar
em consideração requisitos não funcionais como: segurança, usabilidade, performance e padrões de design.
...
\subsection{Survey para Técnicas de Gamificação}
\label{sub:survey_para_t_cnicas_de_gamifica_o}
Será executado um survey com alguns usuários aleatoriamente escolhidos dentre os que interagiram com o piloto.
O objetivo do survey é identificar quais são as técnicas de gamificação mais presentes no piloto executado.
